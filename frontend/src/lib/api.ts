...
import type { AnalysisResponse, AssetSearchResponse, AssistantResponse, AssetHistory, AssetQuote, CalendarResponse, CompareResponse, FinancialsResponse, MarketConditionResponse, NewsImpactResponse, PennyAlgorithmResponse, PennyCandidateExplanationResponse, PennyOpportunitiesResponse, PortfolioEvaluationResponse, PortfolioHolding, QuotesResponse, RiskResponse, SectorResponse, SentimentResponse, TechnicalResponse, SparklinesResponse, WatchlistResponse } from '../types/market';
