...
export interface RiskResponse { symbol: string; asset_type: string; risk_score: number; volatility_level: string; main_risks: string[]; risk_controls: string[]; facts: string[]; interpretation: string; disclaimer: string; metadata?: ResponseMetadata; }
export interface FinancialsResponse { symbol: string; applicable: boolean; status?: string; message?: string; facts?: Record<string, string | number | null>; interpretation?: Record<string, string | null>; risks?: string[]; cautious_action_plan?: string[]; alternative_fundamentals?: { asset_type: string; focus_areas: string[] }; disclaimer: string; metadata?: ResponseMetadata; }
